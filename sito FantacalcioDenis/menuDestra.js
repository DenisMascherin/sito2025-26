...
function aggiornaClassifica() {
    ...
    const classificaStatica = [
        { rank: 1, team: "Napoli", points: 22, logo: "images/napoli.png" },
        { rank: 2, team: "Inter", points: 21, logo: "images/inter.png" },
        { rank: 3, team: "Milan", points: 21, logo: "images/milan.png" },
        { rank: 4, team: "Roma", points: 21, logo: "images/roma.png" },
        { rank: 5, team: "Bologna", points: 18, logo: "images/bologna.png" },
        { rank: 6, team: "Juventus", points: 18, logo: "images/juventus.png" },
        { rank: 7, team: "Como", points: 17, logo: "images/como.png" },
        { rank: 8, team: "Lazio", points: 15, logo: "images/lazio.png" },
        { rank: 9, team: "Udinese", points: 15, logo: "images/udinese.png" },
        { rank: 10, team: "Cremonese", points: 14, logo: "images/cremonese.png" },
        { rank: 11, team: "Atalanta", points: 13, logo: "images/atalanta.png" },
        { rank: 12, team: "Sassuolo", points: 13, logo: "images/sassuolo.png" },
        { rank: 13, team: "Torino", points: 13, logo: "images/torino.png" },
        { rank: 14, team: "Cagliari", points: 9, logo: "images/cagliari.png" },
        { rank: 15, team: "Lecce", points: 9, logo: "images/lecce.png" },
        { rank: 16, team: "Pisa", points: 9, logo: "images/pisa.png" },
        { rank: 17, team: "Parma", points: 7, logo: "images/parma.png" },
