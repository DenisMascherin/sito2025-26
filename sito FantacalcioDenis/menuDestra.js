...
function aggiornaClassifica() {
    ...
    const classificaStatica = [
        { rank: 1, team: "Napoli", points: 21, logo: "images/napoli.png" },
        { rank: 2, team: "Roma", points: 21, logo: "images/roma.png" },
        { rank: 3, team: "Inter", points: 18, logo: "images/inter.png" },
        { rank: 4, team: "Milan", points: 18, logo: "images/milan.png" },
        { rank: 5, team: "Como", points: 16, logo: "images/como.png" },
        { rank: 6, team: "Bologna", points: 15, logo: "images/bologna.png" },
        { rank: 7, team: "Juventus", points: 15, logo: "images/juventus.png" },
        { rank: 8, team: "Cremonese", points: 14, logo: "images/cremonese.png" },
        { rank: 9, team: "Atalanta", points: 13, logo: "images/atalanta.png" },
        { rank: 10, team: "Udinese", points: 12, logo: "images/udinese.png" },
        { rank: 11, team: "Torino", points: 12, logo: "images/torino.png" },
        { rank: 12, team: "Lazio", points: 11, logo: "images/lazio.png" },
        { rank: 13, team: "Sassuolo", points: 10, logo: "images/sassuolo.png" },
        { rank: 14, team: "Cagliari", points: 9, logo: "images/cagliari.png" },
        { rank: 15, team: "Parma", points: 7, logo: "images/parma.png" },
        { rank: 16, team: "Lecce", points: 6, logo: "images/lecce.png" },
        { rank: 17, team: "Verona", points: 5, logo: "images/verona.png" },
        { rank: 18, team: "Fiorentina", points: 4, logo: "images/fiorentina.png" },
        { rank: 19, team: "Pisa", points: 4, logo: "images/pisa.png" },
        { rank: 20, team: "Genoa", points: 3, logo: "images/genoa.png" },
    ];
